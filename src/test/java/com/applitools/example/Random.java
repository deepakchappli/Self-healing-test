...
public class Random {
    ...
    private final static BatchInfo BATCH = new BatchInfo("Random " + RUNNER_NAME);
...
//            String script = "document.querySelector('#hd-openNav > div.h-100.app-container > app-root > div > div.page-content.h-100.w-100.d-flex.flex-column > div > magneto-faq-main > div > div > magneto-faq-search-bar > div > div.search-box__button.ml-auto.d-none.d-sm-flex').id = 'New_button';";
//            ((JavascriptExecutor) driver).executeScript(script);
//            String newSelectorScript = "return document.querySelector('#hd-openNav > div.h-100.app-container > app-root > div > div.page-content.h-100.w-100.d-flex.flex-column > div > magneto-faq-main > div > div > magneto-faq-search-bar > div > div.search-box__button.ml-auto.d-none.d-sm-flex').id;";
//            String newSelector = (String) ((JavascriptExecutor) driver).executeScript(newSelectorScript);
//            System.out.println("New selector: " + newSelector);

//            String element = "const elem = document.querySelector('#hd-openNav > div.h-full.app-container > app-root > div > div.page-content.h-full.w-full.flex.flex-col > div > magneto-faq-main > div > div > magneto-faq-search-bar > div > div.search-box__button.ml-auto.flex-none.sm\\:flex');" ;
//            String script = "elem.classList.remove(\"sm:flex\");";


//            String element = "const elem = document.querySelector('#hd-openNav > div.h-100.app-container > app-root > div > div.page-content.h-100.w-100.d-flex.flex-column > div > magneto-faq-main > div > div > magneto-faq-search-bar > div > div.search-box__button.ml-auto.d-none.d-sm-flex');" ;
//            String script = "elem.classList.remove(\"d-sm-flex\");" +
//                     "elem.classList.add(\"d-lg-flex\");";
//            ((JavascriptExecutor) driver).executeScript(element + script);

//            driver.findElement(By.cssSelector("#hd-openNav > div.h-full.app-container > app-root > div > div.page-content.h-full.w-full.flex.flex-col > div > magneto-faq-main > div > div > magneto-faq-search-bar > div > div.search-box__button.ml-auto.flex-none.sm\\:flex")).click();
            WebElement signup = driver.findElement(By.cssSelector("#loginPanel > p:nth-child(3) > a"));
            signup.click();
            WebElement email = driver.findElement(By.id("customer.firstName"));
//            String change = "document.getElementById('customer.firstName').setAttribute('id','EMAIL');";
//            ((JavascriptExecutor) driver).executeScript(change);
//            String updatedId = (String) ((JavascriptExecutor) driver).executeScript("return document.getElementById('EMAIL').id;");
//            System.out.println("Updated id: " + updatedId);


                System.out.println("Before changing:" + driver.findElement(By.id("customer.firstName")).getAttribute("id"));
                JavascriptExecutor icon = (JavascriptExecutor) driver;
                String logo = "document.getElementById('customer.firstName').setAttribute('id', 'EMAIL')";
                icon.executeScript(logo);
                System.out.println("After changing:" + driver.findElement(By.id("customer.firstName")).getAttribute("id"));


            email.sendKeys("test@applitools.com");
...
//-----------------------Halodoc code----------------------------------------
//            driver.get("https://www.halodoc.com/faq");
//
////            driver.findElement(By.cssSelector("div[class='search-box__button ml-auto flex-none sm:flex']")).click();
//            String element = "const elem = document.querySelector(\"div[class='search-box__button ml-auto flex-none sm:flex']\");";
//            String script = "elem.classList.remove(\"sm-flex\");" +
//                    "elem.classList.add(\"d-lg-flex\");";
//
//            System.out.println("script: " + element + script);
//
//            JavascriptExecutor js = (JavascriptExecutor) driver;
//
//// Combine the element and script correctly
//            String combinedScript = element + script;
//
//            js.executeScript(combinedScript);
//
//            driver.findElement(By.cssSelector("div[class='search-box__button ml-auto flex-none sm:flex']")).click();
//            eyes.check(Target.window().fully().withName("Home Page"));
            eyes.closeAsync();
